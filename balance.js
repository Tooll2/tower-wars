  ...
  CHARACTERS: [
    {
      ...
      badge: 'Ближний бой',
      perkColor: '#f59e0b',
      perkTitle: '💥 Урон x2.0 в упор',
      desc: 'Снижает радиус атаки до 2.0 клеток, но наносит удвоенный сокрушительный урон.',
      towersList: ['Страж Т0 (80 ур)', 'Рыцарь Т1 (200 ур)', 'Капитан Т2 (500 ур)', 'Паладин Т3 (1100 ур)', 'Маршал Т4 (1900 ур)']
    },
    {
      id: 'elves',
      name: '🌙 Эльфы (Лучники)',
